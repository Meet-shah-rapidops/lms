...
// import { isFunction } from '../../../../../src/services/predicate';
 ...
 class StudentExamSchedule extends Component {
  constructor(props) {
    super(props);
    ...
    this.items = [
      {
        ...
        type: 'user',
        dateCreated: '10',
        magnitude: <EuiFlexItem grow={false}>
        <EuiButton fill href="/ExamWarning">
         Take Exam
        </EuiButton>
      </EuiFlexItem>,
        health: <EuiHealth color="success">Multiple Time</EuiHealth>,
      },
      {
        id: 1,
        title:
        ...
        dateCreated: '3',
        magnitude: <EuiFlexItem grow={false}>
        <EuiButton fill href="/studentDashboard/examWarning">
         Take Exam
        </EuiButton>
      </EuiFlexItem>,
        health: <EuiHealth color="danger">One Time</EuiHealth>,
      },
      {
        id: 2,
        title:
